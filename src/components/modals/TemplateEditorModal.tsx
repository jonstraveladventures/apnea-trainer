    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" role="dialog" aria-modal="true" aria-labelledby="template-editor-modal-title">
      <div className="bg-deep-800 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 id="template-editor-modal-title" className="text-lg font-semibold text-white">Customize {editingSessionType}</h3>
          <button
            onClick={handleClose}
          ...
          <div className="bg-deep-700 rounded-lg p-4">
            ...
            {editingSessionType === 'Comfortable CO\u2082 Training' && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-deep-300">Rest Pattern (seconds, comma-separated)</label>
            ...
            {editingSessionType === 'Breath Control' && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm text-deep-300">Box Breathing Duration (minutes)</label>
                    <input
                      type="number"
            ...
            {editingSessionType === 'Recovery & Flexibility' && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm text-deep-300">Diaphragm Stretch Count</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-sm text-deep-300">Diaphragm Stretch Duration (seconds)</label>
                    <input
                      type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm text-deep-300">Side Stretch Count</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-sm text-deep-300">Side Stretch Duration (seconds)</label>
                    <input
                      type="number"
